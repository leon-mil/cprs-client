    ...
    public partial class frmTabAnnualBea : frmCprsParent
    {
       ...
       private void GetData()
       {
        ...
        { 
            ...
            saveFileDialog1.FileName = "cprs"+year2.ToString().Substring(2)+year1.ToString().Substring(2)+owner+".xlsx" ;
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            string sfilename = dir + "\\cprs"+year2.ToString().Substring(2)+year1.ToString().Substring(2)+owner+".xlsx";
