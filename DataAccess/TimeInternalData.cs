...
namespace CprsDAL
{
    public class TimeInternalData
    {
        ...
        public DataTable GetPrivateData(string sdate)
        {
            ...
            dt.Columns[17].Caption = "Data center";
            dt.Columns[18].Caption = "%Change";
            dt.Columns[19].Caption = "Financial";
            dt.Columns[20].Caption = "%Change";
            dt.Columns[21].Caption = "Commercial";
            dt.Columns[22].Caption = "%Change";
            dt.Columns[23].Caption = "Automotive";
            dt.Columns[24].Caption = "%Change";
            dt.Columns[25].Caption = "Sale";
            dt.Columns[26].Caption = "%Change";
            dt.Columns[27].Caption = "Services/Parts";
            dt.Columns[28].Caption = "%Change";
            dt.Columns[29].Caption = "Parking";
            dt.Columns[30].Caption = "%Change";
            dt.Columns[31].Caption = "Food/Beverage";
            dt.Columns[32].Caption = "%Change";
            dt.Columns[33].Caption = "Food";
            dt.Columns[34].Caption = "%Change";
            dt.Columns[35].Caption = "Dining/Drinking";
            dt.Columns[36].Caption = "%Change";
            dt.Columns[37].Caption = "Multi-retail";
            dt.Columns[38].Caption = "%Change";
            dt.Columns[39].Caption = "General Merchandise";
            dt.Columns[40].Caption = "%Change";
            dt.Columns[41].Caption = "Shopping Center";
            dt.Columns[42].Caption = "%Change";
            dt.Columns[43].Caption = "Shopping Mall";
            dt.Columns[44].Caption = "%Change";
            dt.Columns[45].Caption = "Other Commercial";
            dt.Columns[46].Caption = "%Change";
            dt.Columns[47].Caption = "Drug Store";
            dt.Columns[48].Caption = "%Change";
            dt.Columns[49].Caption = "Building Supply Store";
            dt.Columns[50].Caption = "%Change";
            dt.Columns[51].Caption = "Other Stores";
            dt.Columns[52].Caption = "%Change";
            dt.Columns[53].Caption = "Warehouse";
            dt.Columns[54].Caption = "%Change";
            dt.Columns[55].Caption = "General Commercial";
            dt.Columns[56].Caption = "%Change";
            dt.Columns[57].Caption = "Mini-storage";
            dt.Columns[58].Caption = "%Change";
            dt.Columns[59].Caption = "Health Care";
            dt.Columns[60].Caption = "%Change";
            dt.Columns[61].Caption = "Hospital";
            dt.Columns[62].Caption = "%Change";
            dt.Columns[63].Caption = "Medical Building";
            dt.Columns[64].Caption = "%Change";
            dt.Columns[65].Caption = "Special Care";
            dt.Columns[66].Caption = "%Change";
            dt.Columns[67].Caption = "Educational";
            dt.Columns[68].Caption = "%Change";
            dt.Columns[69].Caption = "Preschool";
            dt.Columns[70].Caption = "%Change";
            dt.Columns[71].Caption = "Primary/Secondary";
            dt.Columns[72].Caption = "%Change";
            dt.Columns[73].Caption = "Higher Education";
            dt.Columns[74].Caption = "%Change";
            dt.Columns[75].Caption = "Instructional";
            dt.Columns[76].Caption = "%Change";
            dt.Columns[77].Caption = "Dormitory";
            dt.Columns[78].Caption = "%Change";
            dt.Columns[79].Caption = "Sports/Recreation";
            dt.Columns[80].Caption = "%Change";
            dt.Columns[81].Caption = "Other Educational";
            dt.Columns[82].Caption = "%Change";
            dt.Columns[83].Caption = "Gallery/Museum";
            dt.Columns[84].Caption = "%Change";
            dt.Columns[85].Caption = "Religious";
            dt.Columns[86].Caption = "%Change";
            dt.Columns[87].Caption = "House of Worship";
            dt.Columns[88].Caption = "%Change";
            dt.Columns[89].Caption = "Other Religious";
            dt.Columns[90].Caption = "%Change";
            dt.Columns[91].Caption = "Auxiliary Building";
            dt.Columns[92].Caption = "%Change";
            dt.Columns[93].Caption = "Amusement and Recreation";
            dt.Columns[94].Caption = "%Change";
            dt.Columns[95].Caption = "Theme/Amusement Park";
            dt.Columns[96].Caption = "%Change";
            dt.Columns[97].Caption = "Sports";
            dt.Columns[98].Caption = "%Change";
            dt.Columns[99].Caption = "Fitness";
            dt.Columns[100].Caption = "%Change";
            dt.Columns[101].Caption = "Performance/Meeting Center";
            dt.Columns[102].Caption = "%Change";
            dt.Columns[103].Caption = "Social Center";
            dt.Columns[104].Caption = "%Change";
            dt.Columns[105].Caption = "Movie Theater/Studio";
            dt.Columns[106].Caption = "%Change";
            dt.Columns[107].Caption = "Transportation";
            dt.Columns[108].Caption = "%Change";
            dt.Columns[109].Caption = "Air";
            dt.Columns[110].Caption = "%Change";
            dt.Columns[111].Caption = "Land";
            dt.Columns[112].Caption = "%Change";
            dt.Columns[113].Caption = "Communication";
            dt.Columns[114].Caption = "%Change";
            dt.Columns[116].Caption = "Power";
            dt.Columns[116].Caption = "%Change";
            dt.Columns[117].Caption = "Electric";
            dt.Columns[118].Caption = "%Change";
            dt.Columns[119].Caption = "Manufacturing";
            dt.Columns[120].Caption = "%Change";
            dt.Columns[121].Caption = "Food/Beverage/Tobacco";
            dt.Columns[122].Caption = "%Change";
            dt.Columns[123].Caption = "Chemical";
            dt.Columns[124].Caption = "%Change";
            dt.Columns[125].Caption = "Plastic/Rubber";
            dt.Columns[126].Caption = "%Change";
            dt.Columns[127].Caption = "Nonmetallic Mineral";
            dt.Columns[128].Caption = "%Change";
            dt.Columns[129].Caption = "Fabricated metal";
            dt.Columns[130].Caption = "%Change";
            dt.Columns[131].Caption = "Computer/Electronic/Electrical";
            dt.Columns[132].Caption = "%Change";
            dt.Columns[133].Caption = "Transportation Equipment";
            dt.Columns[134].Caption = "%Change";
