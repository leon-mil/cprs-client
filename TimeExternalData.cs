            ...
            using (SqlConnection sql_connection = new SqlConnection(GeneralData.getConnectionString()))
            {
                ...
                else if (tableType == "V")
                {
                    ...
                    sql_command = new SqlCommand(@" Select t.DATE6, t.VXXXX" + seasonal +
                        ...
                        @", t.N0211" + seasonal + @", t.V02CC" + seasonal + @", t.V03XX" + seasonal +
                    ...
                    dt.Columns[9].Caption = "Financial";
                    dt.Columns[10].Caption = "Commercial (inc. Farm)";
                    dt.Columns[11].Caption = "Automotive";
                    dt.Columns[12].Caption = "Sales";
                    dt.Columns[13].Caption = "Service/parts";
                    dt.Columns[14].Caption = "Parking";
                    dt.Columns[15].Caption = "Food/beverage";
                    dt.Columns[16].Caption = "Food";
                    dt.Columns[17].Caption = "Dining/drinking";
                    dt.Columns[18].Caption = "Multi-retail";
                    dt.Columns[19].Caption = "General merchandise";
                    dt.Columns[20].Caption = "Shopping center";
                    dt.Columns[21].Caption = "Shopping mall";
                    dt.Columns[22].Caption = "Other commercial";
                    dt.Columns[23].Caption = "Drug store";
                    dt.Columns[24].Caption = "Building supply store";
                    dt.Columns[25].Caption = "Other stores";
                    dt.Columns[26].Caption = "Warehouse";
                    dt.Columns[27].Caption = "General commercial";
                    dt.Columns[28].Caption = "Mini-storage";
                    dt.Columns[29].Caption = "Health care";
                    dt.Columns[30].Caption = "Hospital";
                    dt.Columns[31].Caption = "Medical building";
                    dt.Columns[32].Caption = "Special care";
                    dt.Columns[33].Caption = "Educational";
                    dt.Columns[34].Caption = "Preschool";
                    dt.Columns[35].Caption = "Primary/secondary";
                    dt.Columns[36].Caption = "Higher education";
                    dt.Columns[37].Caption = "Instructional";
                    dt.Columns[38].Caption = "Dormitory";
                    dt.Columns[39].Caption = "Sports/recreation";
                    dt.Columns[40].Caption = "Other educational";
                    dt.Columns[41].Caption = "Gallery/museum";
                    dt.Columns[42].Caption = "Religious";
                    dt.Columns[43].Caption = "House of worship";
                    dt.Columns[44].Caption = "Other religious";
                    dt.Columns[45].Caption = "Auxiliary building";
                    dt.Columns[46].Caption = "Amusement and Recreation";
                    dt.Columns[47].Caption = "Theme/amusement park";
                    dt.Columns[48].Caption = "Sports";
                    dt.Columns[49].Caption = "Fitness";
                    dt.Columns[50].Caption = "Performance/ meeting center";
                    dt.Columns[51].Caption = "Social center";
                    dt.Columns[52].Caption = "Movie theater/ studio";
                    dt.Columns[53].Caption = "Transportation";
                    dt.Columns[54].Caption = "Air";
                    dt.Columns[55].Caption = "Land";
                    dt.Columns[56].Caption = "Communication";
                    dt.Columns[57].Caption = "Power (inc. Gas and Oil)";
                    dt.Columns[58].Caption = "Electric";
                    dt.Columns[59].Caption = "Manufacturing";
                    dt.Columns[60].Caption = "Food/beverage/ tobacco";
                    dt.Columns[61].Caption = "Chemical";
                    dt.Columns[62].Caption = "Plastic/rubber";
                    dt.Columns[63].Caption = "Nonmetallic mineral";
                    dt.Columns[64].Caption = "Fabricated metal";
                    dt.Columns[65].Caption = "Computer/ electronic/ electrical";
                    dt.Columns[66].Caption = "Transportation equipment";
                }
                else
                {
