/********************************************************************
 ...
 Description   : This screen will allow users to display and 
       update VIP Benchmark Annual Data

 Detail Design : Detailed User Requirements for VIP Benchmark Annual

 Other         : Called by: Tabulations -> Benchmark -> Annual
...
namespace Cprs
{
    public partial class frmBenAnnual : frmCprsParent
    {
        DataTable vipannual = new DataTable();
        VipBenchmarkAnnualData data_object = new VipBenchmarkAnnualData();
        ...
        private void frmBenAnnual_Load(object sender, EventArgs e)
        {
            formloading = true;
        ...
        {
            vipannual = data_object.GetBenchmarkAnnualData(series);
            dgData.DataSource = vipannual;
        ...
        private void SetupData()
        {
            ...
            if (latest == false)
            {
                ...
                {
                    data_object.InsertRows(nextyr, toc);
                }
            }
        }
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            printer.printDocument.DocumentName = "VIP Benchmark Annual";
        ...
        private void frmBenAnnual_FormClosing(object sender, FormClosingEventArgs e)
        {
            //add record to cpraccess
