...
Program Name:       frmCeflagSelPopup.cs	    	
...
namespace Cprs
{
    public partial class frmCeflagSelPopup : Form
    {
        /*Public properties */
        ...
        public frmCeflagSelPopup(int nValue)
        {
            InitializeComponent();
            newValue = nValue;
        }

        private void frmCeflagSelPopup_Load(object sender, EventArgs e)
        {
            if (newValue == 0)
            {
