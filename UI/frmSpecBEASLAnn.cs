...
Program Name    : frmSpecBEASLAnn.cs	    	
Programmer      : Christine Zhang   
Creation Date   : 10/17/2018
Inputs          : None                 
Parameters      : None 
Outputs         : None	
Description     : Display Annual Special State and local BEA tabulation
...
namespace Cprs
{
    public partial class frmSpecBEASLAnn : frmCprsParent
    {
        public frmSpecBEASLAnn()
        {
            InitializeComponent();
        }
        ...
        private void frmSpecBEASLAnn_Load(object sender, EventArgs e)
        {
            ...
            data_object = new SpecBEAData();
            stored_main = data_object.GetSLBeaAnnTable(cbYear.Text, sel_factor);
        ...
        private void SetColumnHeader()
        {
            ...
            for (int i = 1; i <= 12; i++)
            {
                ...
                int mm = 13 - i;
                if (mm >=10)
                    dgData.Columns[j1].HeaderText = "State " + cbYear.Text  + mm;
                else
                    dgData.Columns[j1].HeaderText = "State " + cbYear.Text + "0" + mm;
                ...
                int j2 = 3 * i - 1;
                if (mm >=10)
                    dgData.Columns[j2].HeaderText = "Local " + cbYear.Text + mm;
                else
                    dgData.Columns[j2].HeaderText = "Local " + cbYear.Text + "0" + mm;
            ...
            dgData.Columns[37].HeaderText = "State " + cbYear.Text;
            ...
            dgData.Columns[38].HeaderText = "Local " + cbYear.Text;
            ...
            dgData.Columns[39].AutoSizeMode = DataGridViewAutoSizeColumnMode.DisplayedCells;
        ...
        private void frmSpecBEASLAnn_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void btnTable_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog1.FileName = "SLBEAAnn.xlsx";
            ...
            //if (GeneralFunctions.IsFileinUse(dir + "\\SLBEAAnn.xlsx"))
            //{
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            printer.printDocument.DocumentName = "BEA SL Annual Print";
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            FileInfo fileInfo = new FileInfo(saveFilename);
            string dir = MapNetwork.Pathing.GetUNCPath(fileInfo.DirectoryName);
            string sfilename = dir + "\\SLBEAAnn.xlsx";
        ...
        private void ExportToExcel1(string sel_year)
        {
            ...
            xlWorkSheet.Cells[4, 38] = "State \n" + sel_year;
            xlWorkSheet.Cells[4, 39] = "Local \n" + sel_year;
            xlWorkSheet.Cells[4, 40] = "Total \n" + sel_year;

            ///*for datatable */
            DataTable dt = data_object.GetSLBeaAnnTable(sel_year, sel_factor);
