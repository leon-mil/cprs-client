...
Program Name:       frmGlobalInsightMon.cs	    	
Programmer:         Christine Zhang
Creation Date:      4/18/2017
Inputs:             None                 
Parameters:		    None 
Outputs:		    None	
Description:	    Display monthly global insight tabulation

Detailed Design:    Detailed User Requirements for the global insight month Screen 
Other:	            
Revision History:	
**************************************************************************************************
 Modified Date :  
...
namespace Cprs
{
    public partial class frmGlobalInsightMon : frmCprsParent
    {
        private string sdate;

        public frmGlobalInsightMon()
        {
            InitializeComponent();
            
        }

        private void frmGlobalInsightMon_Load(object sender, EventArgs e)
        {
            ...
            DataTable table = gdata.GetGlobalInsightMonData(sdate, premon, ppmon, p3mon, p4mon);
            ...
            lblTitle.Text = "GLOBAL INSIGHT " + sdate;
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            printer.printDocument.DocumentName = "Global Insight Month Print";
        ...
        private void frmGlobalInsightMon_FormClosing(object sender, FormClosingEventArgs e)
        {
